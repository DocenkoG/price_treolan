...
def download( cfg ):
    ...
    try:
        ...
        time.sleep(2)
        driver.find_element_by_xpath(u"//input[@value='Вход']").click()
        time.sleep(3)
#        driver.find_element_by_xpath("//option[@value='1']").click()
#        time.sleep(2)
        Select(driver.find_element_by_xpath("//select[@name='ncfltr']")).select_by_visible_text(u"Не показывать некондицию")
        time.sleep(2)
        driver.find_element_by_xpath("//option[@value='1']").click()
#        time.sleep(2)
#        Select(driver.find_element_by_name("ncfltr")).select_by_visible_text(u"Не показывать некондицию")
#        time.sleep(2)
#        driver.find_element_by_xpath("//option[@value='1']").click()
        time.sleep(12)
        driver.quit()
